#ifndef _PROJECT_PUNCHER_MULTI_LANGUAGE_
#define _PROJECT_PUNCHER_MULTI_LANGUAGE_
...
struct AnalogMenuInfo_ML : AnalogMenuInfo {
	AnalogMenuInfo_ML(const char *&a, int b, int c, int d, MenuCallbackFn e, int f, int g, char h[]){
