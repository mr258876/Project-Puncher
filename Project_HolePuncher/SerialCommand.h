...
const PROGMEM byte PuncherBusyResp[8] = {0xE0, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0xD9};
const PROGMEM byte WifiCommandDisabledResp[8] = {0xE0, 0xA0, 0x00, 0x00, 0x00, 0x00, 0x00, 0xB9};
const PROGMEM byte EncoderNotDetectedResp[8] = {0xE2, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x73};
const PROGMRM byte HeartBeat[8] = {0x01, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x41};
